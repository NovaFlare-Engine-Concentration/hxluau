...
extern class Lua {
    ...
    // Garbage collector operations (lua_GCOp)
    // Values match enum order in project/luau/include/lua.h
    ...
    public static inline var LUA_GCISRUNNING:Int = 5;
    public static inline var LUA_GCSTEP:Int = 6;
    public static inline var LUA_GCSETGOAL:Int = 7;
    public static inline var LUA_GCSETSTEPMUL:Int = 8;
    public static inline var LUA_GCSETSTEPSIZE:Int = 9;
